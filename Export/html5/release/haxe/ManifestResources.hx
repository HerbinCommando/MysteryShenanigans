...
@:keep @:bind #if display private #end class __ASSET__assets_images_buy_lame_souvenirs_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }@:keep @:bind #if display private #end class __ASSET__assets_font_vt323_woff2 extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_font_vt323_regular_ttf extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_data_shennanagen_json extends null { }
...
@:file("Assets/data/TestShennanagens.json") #if display private #end class __ASSET__assets_data_shennanagen_json extends haxe.io.Bytes {}
