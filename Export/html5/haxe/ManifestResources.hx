...
@:keep @:bind #if display private #end class __ASSET__assets_data_thejampackedtestmysterytour_json extends null { }
...
@:file("Assets/data/TheJamPackedTestMysteryTour.json") #if display private #end class __ASSET__assets_data_thejampackedtestmysterytour_json extends haxe.io.Bytes {}
